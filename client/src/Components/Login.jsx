              ...
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                  ...
                  <form className="space-y-4 md:space-y-6" onSubmit={hanldeLogin}>
                      <div>
                          ...
                          <input onChange={(e) => setEmail(e.target.value)} value={email} className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-rose-600 focus:border-rose-600 block w-full p-2.5" placeholder="abc@xyz.com" required="" />
                      </div>
                      <div>
                  ...
                  <div>Don't have a account? <Link to='/signup' className="hover:underline">Register Now</Link></div>
              </div>
          </div>
      </div>
    </section>
